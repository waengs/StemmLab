...
function useBreathingPacePostStyles() {
...
export function BreathingPacePostActivity({ result, onComplete }: Props) {
  const styles = useBreathingPacePostStyles();
  return (
    <ActivityMcqPostQuiz
...
export function BreathingPaceDiscussion({ onComplete }: { onComplete?: () => void }) {
  const { t } = useTranslation();
  const styles = useBreathingPacePostStyles();
  return (
    <View style={styles.container}>
      <ActivityDiscussionCard activityId="breathing-pace" styles={styles} />
          {onComplete && (
        <Button 
