...
function useHumanPerformancePostStyles() {
...
export function HumanPerformancePostActivity({ result, onComplete }: Props) {
  const styles = useHumanPerformancePostStyles();
  return (
    <ActivityMcqPostQuiz
...
export function HumanPerformanceDiscussion({ onComplete }: { onComplete?: () => void }) {
  const { t } = useTranslation();
  const styles = useHumanPerformancePostStyles();
  return (
    <View style={styles.container}>
      <ActivityDiscussionCard activityId="human-performance" styles={styles} />
          {onComplete && (
        <Button 
