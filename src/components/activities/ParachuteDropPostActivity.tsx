...
function useParachuteDropPostStyles() {
...
export function ParachuteDropPostActivity({ result, onComplete }: Props) {
  const styles = useParachuteDropPostStyles();
  return (
    <ActivityMcqPostQuiz
...
export function ParachuteDropDiscussion({ onComplete }: { onComplete?: () => void }) {
  const { t } = useTranslation();
  const styles = useParachuteDropPostStyles();
  return (
    <View style={styles.container}>
      <ActivityDiscussionCard activityId="parachute-drop" styles={styles} />
      {onComplete && (
        <Button 
